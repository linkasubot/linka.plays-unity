...
public class HighlightsPostEffect : MonoBehaviour
{
	...
	private void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		// Downsample and blur the result buttonImage using standard BlurOptimized buttonImage effect
		...
		// Excluding the original buttonImage from the blurred buttonImage, leaving out the areal alone
		...
		// Renders the result buttonImage over the main camera's G-Buffer
